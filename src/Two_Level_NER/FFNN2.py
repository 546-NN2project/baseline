...
class HiddenLayer(object):
    def __init__(self, rng, input, n_in, n_out, W=None, b=None,
                 activation=T.tanh):
        """
        Typical hidden layer: Weight matrix W is of shape (n_in,n_out)
...
class FFNN(object):    
    def __init__(self, rng, input, n_in, n_hidden, n_out):
        ...
        """
        Feed-forward Neural Network with 4 hidden layers and
        ...
        # be small
        self.L1 = (
            abs(self.hiddenLayer1.W).sum() + abs(self.hiddenLayer2.W).sum() + abs(self.hiddenLayer3.W).sum() + abs(self.hiddenLayer4.W).sum() + abs(self.logRegressionLayer.W).sum()
        )

        # square of L2 norm ; one regularization option is to enforce
        # square of L2 norm to be small
        self.L2_sqr = (
            (self.hiddenLayer1.W ** 2).sum() + (self.hiddenLayer2.W ** 2).sum() + (self.hiddenLayer3.W ** 2).sum() + (self.hiddenLayer4.W ** 2).sum() + (self.logRegressionLayer.W ** 2).sum()
        )
        ...
        # made out of
        self.params = self.hiddenLayer1.params + self.hiddenLayer2.params + self.hiddenLayer3.params + self.hiddenLayer4.params + self.logRegressionLayer.params

        # keep track of model input
        self.input = input

    def getstate(self):
        return (self.hiddenLayer1.params, self.hiddenLayer2.params, self.hiddenLayer3.params, self.hiddenLayer4.params, self.logRegressionLayer.params)
